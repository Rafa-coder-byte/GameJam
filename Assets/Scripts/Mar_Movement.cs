...
{
    public float alturaMovimiento = 0.5f;  // Altura m�xima a la que el mar subir�  
    public float velocidadMovimiento = 1f;  // Velocidad del movimiento  
    public float tiempoArriba = 2f;  // Tiempo en la posici�n alta  
    public float tiempoAbajo = 5f;  // Tiempo en la posici�n baja  

    private Vector3 posicionInicial;  // Para guardar la posici�n inicial del mar  
    ...
    private IEnumerator SubirMar()
    {
        ...
        Vector3 posicionFinal = posicionInicial + new Vector3(0, alturaMovimiento, 0); // Nueva posici�n al subir  
        ...
        // Asegurarse de que est� exactamente en la posici�n final  
    ...
    {
        float tiempoTranscurrido = 0f;
        Vector3 posicionFinal = posicionInicial; // Regresar a la posici�n inicial  
        ...
        // Asegurarse de que est� en la posici�n inicial  
        transform.position = posicionFinal;
    }
}*/